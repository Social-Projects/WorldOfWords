...
namespace WorldOfWords.Domain.Services
{
    public interface IWordTranslationService
    {
        ...
        Task<List<WordTranslationImportModel>> GetWordsFromIntervalAsync(int startOfInterval, int endOfInterval, int originalLangId, int translationLangId);
        Task<List<WordTranslationImportModel>> GetWordsWithSearchValueAsync(string searchValue, int startOfInterval, int endOfInterval, int originalLangId, int translationLangId);
        Task<int> GetAmountOfWordTranslationsByLanguageAsync(int originalLangId, int translationLangId);
        Task<int> GetAmountOfWordsBySearchValuesAsync(string searchValue, int originalLangId, int translationLangId);
