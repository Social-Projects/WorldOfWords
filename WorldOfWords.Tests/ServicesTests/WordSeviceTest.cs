...
namespace WorldOfWords.Tests.ServicesTests
{
    ...
    class WordSeviceTest
    {
        ...
        //[Test]
        //public async Task Add_RuturnsNegativeOne_IfWordExists()
        //{
        //    //Arrange
        //    string value = "value";
        //    int Id = 8;
        ...
        //                         }
        //                     }.AsQueryable<Word>();
        //    Word word = new Word { Value = value, LanguageId = Id };
        //    var mockSet = GenerateMockDbSet<Word>(words);
        //    _words.Setup(w => w.GetAll()).Returns(mockSet.Object);
        ...
        //[Test]
        //public async Task Add_ReturnsWordId_IfWordNotExists()
        //{
        //    //Arrange
        //    string value = "value";
        //    int Id = 8;
        ...
        //    //Assert
        //    _factory.Verify(f => f.GetUnitOfWork(), Times.Exactly(2));
        //    _uow.Verify(u => u.WordRepository, Times.Exactly(2));
        //    _words.Verify(w => w.GetAll(), Times.Once);
        //    _words.Verify(w => w.Add(It.IsAny<Word>()), Times.Once);
        //    Assert.AreEqual(actual, expected);
        //}

        //[Test]
        //public void Add_ThrowsArgNullException()
        //{
        //    //Arrange
        //    string value = "value";
        //    int Id = 8;
