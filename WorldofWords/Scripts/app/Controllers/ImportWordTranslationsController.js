app.controller('ImportWordTranslationsController', ["$scope", "$modal", "$modalInstance", "WordTranslationService", "languageId",
    function ($scope, $modal, $modalInstance, WordTranslationService, languageId) {
