app.controller('EditCourseController', ["$modal", "$scope", "$window", "$routeParams", "$timeout", "WordSuiteService", "CourseService",
    function ($modal, $scope, $window, $routeParams, $timeout, WordSuiteService, CourseService) {
